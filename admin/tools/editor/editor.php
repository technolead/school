		...
		function ajaxLoad(file) {
			...
			$.ajax({
			   ...
			   success: function(file_content){
				 ...
				 tinyMCE.get('content').dom.loadCSS('css.php?file='+file+'&discriminator='+Math.random());
...
<body>
<table style="width: 950px;" align="center" border="0" cellpadding="0" cellspacing="0">
<tbody>
<tr>
<td style="padding-left: 25px;" align="left" valign="top" width="130"><a id="open_file" href="http://localhost/jqueryFileTree.php" style="color: #990000; font-size: 12px; text-decoration: none;"><img src="http://localhost/editor-images/folder_open.png" align="absmiddle" border="0" />&nbsp;<b>Open a file</b></a></td>
<td align="left" valign="top" width="820"><a href="javascript:ajaxSave()" style="color: #990000; font-size: 12px; text-decoration: none;"><img src="http://localhost/editor-images/directory.png" align="absmiddle" border="0" />&nbsp;<b>Save</b></a></td>
</tr>
</tbody>
</table>
<br />
...
<tbody>
<tr>
<td align="center" valign="top"><textarea name="content" id="content">&lt;?php echo $content?&gt;</textarea></td>
</tr>
</tbody>
</table>
<input id="file_name_id" name="file_name" type="hidden" />
</body>
</html>