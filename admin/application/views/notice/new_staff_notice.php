<div class='form_content' style="width:880px;">
    <h3><?=$page_title?></h3>
    <form id="valid_form" action='<?=site_url('notice/new_staff_notice')?>' method='post'>
        <table>
            <tr>
            ...
            <tr>
                ...
                <td><textarea name="des" id="content" rows="15" class="" cols="60"><?=set_value('des')?></textarea><?=form_error('des','<span class="block">','</span>')?></td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <input type="radio" name="posted_to" value="2" class="jposted_to" />Send Individual Student
                    <input type="radio" name="posted_to" value="3" class="jposted_to" />All Student
                    <div class="jindividual_box" style="display:none;">
                        Student ID: <input type="hidden" name="student_id" value="<?=$student_id?>" />
                        <input type='text' autocomplete='off' class='width_160 jstudent_username text ui-widget-content ui-corner-all'  name='user_name' value='<?=set_value('user_name')?>' />
