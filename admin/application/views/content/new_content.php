<div class='form_content' style="width:880px;">
    ...
    <div class="clear"></div>
    <form id="valid_form" action='<?=site_url('content/new_content/'.$content_id)?>' method='post'>
        <table>
            <tr>
                <th>Menu <span class='req_mark'>*</span></th>
                <td><select name="menu_id" class="required"><?=$this->mod_content->get_menu_options(TRUE,$menu_id)?></select></td>
            </tr>
            <tr>
                <th>Content Title <span class='req_mark'>*</span></th>
