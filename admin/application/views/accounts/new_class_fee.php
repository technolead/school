<div class='form_content'>
    ...
    <form id="valid_form" action="<?=site_url('accounts/new_class_fee')?>" method='post'>
        <table>
            <tr>
                <th>Class</th>
                <td><select name="class_id" class="jaccount_class_id"><?=combo::registered_class_options($std_info['student_id'],set_value('class_id'))?></select><?=form_error('class_id','<span>','</span>')?></td>
            </tr>
            <tr>
                <th>Class Fee</th>
                <td><input type="text" name="class_fee" value="<?=set_value('class_fee')?>" readonly class="text ui-widget-content ui-corner-all required width_160 jclass_fee jmapped_value" /><?=form_error('class_fee','<span>','</span>')?></td>
            </tr>
            <tr>
                <th>Class Start Date</th>
                <td><input type="text" name="class_start_date" value="<?=set_value('class_start_date')?>" readonly class="text ui-widget-content ui-corner-all required width_160 jstart_date" /></td>
            </tr>
            <tr>
                <th>Class End Date</th>
                <td><input type="text" name="class_end_date" value="<?=set_value('class_end_date')?>" readonly class="text ui-widget-content ui-corner-all required width_160 jend_date" /></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="total_balance" value="<?=set_value('total_balance')?>" class="text ui-widget-content ui-corner-all required width_160 jtotal_balance" autocomplete="off" /><span class="jbalance_error"></span><?=form_error('totla_balance','<span>','</span>')?></td>
            </tr>
            <tr>
                <th>Comments</th>
                <td><textarea name="class_comment" rows="3" cols="30"><?=set_value('class_comment')?></textarea></td>
            </tr>
            <tr>
                <th>&nbsp;</th>
                <td>
