<div class='form_content'>
    ...
    <form id="valid_form" action='<?=site_url($action)?>' method='post'>
        <table>
            ...
            <tr>
                <th>Fee Description <span class='req_mark'>*</span></th>
                <td><textarea cols="20" rows="3" name="description"><?=set_value('description',$description)?></textarea><?=form_error('description','<span>','</span>')?></td>
            </tr>
