<div class='form_content'>
    ...
    <form action='<?=site_url('student/promote_class')?>' method='post'>
        <table>
            ...
            <tr>
             ...
             <tr>
                ...
                <td><select name="optional_module_id" class="jclass_optional_module"><option value="">Select Subject Module</option></select></td>
            </tr>

            <tr>
                <th>Class Status <span class='req_mark'>*</span></th>
                <!--<td><select name="class_status" class="input_txt"><?=combo::get_status_options('CLASS_STATUS')?></select><?=form_error('class_status','<span>','</span>')?></td>-->
                <td><select name="class_status" class="input_txt"><?=combo::get_class_module_status_options(set_value('class_status'))?></select><?=form_error('class_status','<span>','</span>')?></td>
            </tr>
            <tr>
                <th>Class Status Change Date</th>
                <td><input type='text' name='class_status_date' value='' class='input_txt width_160 date_picker' /><?=form_error('class_status_date','<span>','</span>')?></td>
            </tr>

            <tr>
                <th>Comments</th>
                <td><textarea name='class_comment' rows='5' cols='40' class="input_txt"></textarea></td>
            </tr>
        </table>
        <div class="txt_center">
            <input type='submit' name='promote_class' value='Promote Class' class='button' /> <input type='button' name='cancel' value='Cancel' class='cancel' />
        </div>
    </form>
</div>