<script type="text/javascript">
    function doOperation(commnad)
    {
        if(commnad=='add')
        {
            window.location='letters/new_letter_type';
        }
        if(commnad=='edit')
        {
            ...
            window.location='letters/edit_letter_type/'+id;
        }
        if(commnad=='delete')
        {
            ...
            if(confirm('Are you sure to delete the selected type?')){
                window.location='letters/delete_letters_type/'+id;
            }
        }
        if(commnad=='enabled' || commnad=='disabled')
        {
            ...
            if(confirm('Are you sure to update the statue of selected letters?')){
                window.location='letters/letters_type_status/'+id+'/'+commnad;
            }
        }
    }
