<div class='form_content'>
    ...
    <form action='<?=site_url('report/view_additional_fee')."/".$payment_type?>' method='post'>
        <table>
            <tr>
                <th>Date</th>
            ...
            <tr>
                ...
                <td><input type="text" name="description" class="text ui-corner-all" value="<?=set_value('description',$_REQUEST['description'])?>" /></td>
            </tr>
...
<div class='table_content'>
    <div class="pagination_links">
        ...
        <a href='#print_view' rel="<?=site_url('report/print_additional_fee')?>" class="print_view right" title="Print View">Print View</a>
        <div class="clear"></div>
    </div>
