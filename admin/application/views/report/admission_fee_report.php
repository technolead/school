<div class='form_content'>
    ...
    <form action='<?=site_url('report/view_admission_fee')."/".$payment_type?>' method='post'>
        <table>
            <tr>
                <th>Date</th>
...
<div class='table_content'>
    <div class="pagination_links">
        ...
        <a href='#print_view' rel="<?=site_url('report/print_admission_fee')?>" class="print_view right" title="Print View">Print View</a>
        <div class="clear"></div>
    </div>
