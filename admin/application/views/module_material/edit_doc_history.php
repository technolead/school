<div class='form_content'>
    <form action='<?=site_url('module_material/edit_doc_history/'.$module_material_id)?>' method='post' enctype="multipart/form-data">
        <table>
            <tr>
                <th>Staff Name</th>
                <td><?=$staff_name?></td>
            ...
            <tr>
                ...
                <td><select class="text ui-widget-content required ui-corner-all width_200" name="module_id"><?=$this->mod_module_material->get_staff_module_options($module_id,$staffs_id)?></select><?=form_error('module_id','<span>','</span>')?></td>
            </tr>
            <tr>
                <th>Lecture Notes <span class='req_mark'>*</span></th>
                <td><textarea name='lecture_notes' rows='10' cols='50'><?=$lecture_notes?></textarea><?=form_error('lecture_notes','<span class="block">','</span>')?></td>
            </tr>
            <tr>
                <th>Lecture File</th>
                <td>
